...
var Bloom = (function () {
  ...
  var Flower = Meta_Object.sub_class('Flower', {
    ...
    click: function(meta_object, action) {
  ...
  var Tabbed_Panel = Flower.sub_class('Tabbed_Panel', {
    block: 'tabbed-panel',
    children: [],
    initialize: function() {
    ...
    set_tab: function(item) {
      ...
      if (this.active_tab) {
        ...
        this.active_tab.get_connection('tab').removeClass('active');
      }
      
      item.element.show();
      item.get_connection('tab').addClass('active');      
    }
  });
