...
var Bloom = (function () {
  ...
  var Combo_Box = Flower.subclass('Combo_Box', {
    ...
    get_selection: function() {
      var index = this.element.find('option:selected').val();
  ...
  var Dialog_Old = Flower.sub_class('Dialog_Old', {
    active: false,
    width: 340,
    height: 500,
    options: {},
  ...
  var More = Meta_Object.sub_class('More', {
    limit: 5,
  ...
  var Confirmation_Dialog = Dialog_Old.sub_class('Confirmation_Dialog', {
    block: 'confirmation',
    height: 200,
    initialize: function(){
  ...
  var Alert_Dialog = Dialog_Old.sub_class('Alert_Dialog', {
    block: 'alert',
    height: 200,
    initialize: function(){
      this.listen(this, 'button', function() {
