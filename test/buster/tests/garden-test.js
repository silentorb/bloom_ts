...
buster.testCase('Irrigation', {
  ...
  initialize: function() {
    ...
    return assert.greater(irrigation.channels.length, 1);
  },
  compare: function() {
    assert(this.irrigation.compare(this.irrigation.channels[1].pattern, 'warrior'));
    assert(this.irrigation.compare('hello/frog', 'hello/frog'));
    refute(this.irrigation.compare('hello/frog', 'hello/*'));
    assert(this.irrigation.compare('hello/frog', ['hello', 'frog']));
